...
describe('Incremendator Component', () => {
    ...
    it('Debe mostrar en el input el valor del progreso', () => {
        ...
        fixture.detectChanges(); //Los cambios pueden tardar más que la ejecución de la prueba
        fixture.whenStable().then( () => { //Permite ejecutar la prueba una vez se detecte el cambio
    ...
    it('Deben existir dos botones', () => {
        const elem = fixture.debugElement.queryAll(By.css('button'));
